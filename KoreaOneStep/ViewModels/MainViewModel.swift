...
final class MainViewModel {
    let inputSearchLocationBasedTourismInformationTrigger: CustomObservable<CLLocationCoordinate2D?> = CustomObservable(nil)
    let inputForTableViewUpdate: CustomObservable<(CLLocationCoordinate2D?, FilteringOrder.FilteringDistance, FilteringOrder)> = CustomObservable((nil, .oneKiloMeter, .title))
    let inputTourType: CustomObservable<(CLLocationCoordinate2D?, FilteringOrder.FilteringDistance, FilteringOrder, TourType?)> = CustomObservable((nil, .oneKiloMeter, .title, nil))
    let inputAddNewBookmark: CustomObservable<LBItem?> = CustomObservable(nil)
    let inputRemoveBookmark: CustomObservable<LBItem?> = CustomObservable(nil)
    let inputContentVCTableViewDidSelectRowAtTrigger: CustomObservable<LBItem?> = CustomObservable(nil)
    let inputSearchVCTableViewDidSelectRowAt: CustomObservable<KSItem?> = CustomObservable(nil)
    let inputDetailVCLeftBarButtonItemTappedTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let inputDetailVCViewDidLoadTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let inputDetailVCAddressCellTappTrigger: CustomObservable<(Double?, Double?)> = CustomObservable((nil, nil))
    let inputActivityIndicatorStopTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let inputActivityIndicatorStartTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let inputSearchUserCurrentLocationTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let inputUpdateUserCurrentLocationTrigger: CustomObservable<Void?> = CustomObservable(nil)
    
    let outputLocationBasedTouristDestinationList: CustomObservable<[SearchResulData]?> = CustomObservable(nil)
    let outputUserCurrentLocationInfoToMainVC: CustomObservable<CLLocationCoordinate2D?> = CustomObservable(nil)
    let outputUserCurrentLocationInfoToContentVC: CustomObservable<CLLocationCoordinate2D?> = CustomObservable(nil)
    let outputSelectedTouristDestination: CustomObservable<LBItem?> = CustomObservable(nil)
    let outputTappedTouristDestination: CustomObservable<KSItem?> = CustomObservable(nil)
    let outputDetailVCLeftBarButtonItemTappedTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let outputDetailVCViewDidLoadTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let outputDetailVCAddressCellTappTrigger: CustomObservable<(Double?, Double?)> = CustomObservable((nil, nil))
    let outputActivityIndicatorStopTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let outputActivityIndicatorStartTrigger: CustomObservable<Void?> = CustomObservable(nil)
    let outputShowAlertTriggerForAuthorization: CustomObservable<Bool> = CustomObservable(false)
