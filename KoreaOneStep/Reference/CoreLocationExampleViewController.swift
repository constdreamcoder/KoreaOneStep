...
class CoreLocationExampleViewController: UIViewController {
...
extension CoreLocationExampleViewController {
...
// 3. 위치 프로토콜 선언
extension CoreLocationExampleViewController: CLLocationManagerDelegate {
